                    ...
                    <div className='rightContent w-[80%] !py-3'>
                        <div className='!w-full !mb-2 !rounded-md flex items-center justify-between !p-2' style={{ backgroundColor: '#f1f1f1', minHeight: '50px' }}>
                            ...
                            <div className='col2 ml-auto flex items-center justify-end gap-2'>
                                ...
                                >
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Sales,highest to lowest</MenuItem>
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Relevance</MenuItem>
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Name, A to Z</MenuItem>
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Name, Z to A</MenuItem>
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Price, low to high</MenuItem>
                                    <MenuItem onClick={handleClose} className='!text-[13px] !text-[#000] text-capitalise'>Price, high to low</MenuItem>
                                </Menu>
                            </div>
