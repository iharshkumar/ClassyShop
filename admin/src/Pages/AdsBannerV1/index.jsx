...
const AdsBannerV1List = () => {
    ...
    const deleteSlide = (id) => {
        deleteData(`/api/adsBannerV1/${id}`).then((res) => {
            context?.alertBox("success", "Ads Banner V1 deleted")
            getData();
        })
    }
    ...
    return (
        <>
            <div className='flex items-center justify-between !px-2 !py-0 !mt-3'>
                <h1 className='text-[20px] font-[600]'>Ads Banner V1 List</h1>
...
export default AdsBannerV1List
