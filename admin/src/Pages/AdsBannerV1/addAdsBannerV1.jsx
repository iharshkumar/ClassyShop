...
const AddAdsBannerV1 = () => {
    ...
    const removeImg = (image, index) => {
        var imageArr = [];
        imageArr = previews
        deleteImage(`/api/adsBannerV1/deleteImage?img=${image}`).then(() => {
    ...
    const handleSubmit = (e) => {
        ...
        postData("/api/adsBannerV1/add", formFields).then((res) => {
            setTimeout(() => {
                setIsLoading(false);
