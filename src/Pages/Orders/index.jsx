                ...
                <div className='col2 w-[80%] '>
                    <div className='!shadow-md !rounded-md !bg-white'>
                        <div className='  !p-3 !w-full !border-b border-[rgba(0,0,0,0.1)]'>
                            ...
                            <p className='!mt-0'>There are <span className='font-bold text-[#ff5252]'>2 </span>products in my list
                            </p>
                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-body border-collapse">
                                    ...
                                    <tbody>
                                        <tr className="!bg-white !border-b !border-[rgba(0,0,0,0.1)] hover:!bg-gray-50">
                                            ...
                                            <td className="!px-6 !py-4">
                                                <span className='text-red-500'>6732kjhfjksah32ggfd</span>
                                            </td>

                                            <td className="!px-6 !py-4">
                                                <span className='text-red-500'>pay_id63r87265sgf</span>
                                            </td>
                                            ...
                                            <td className="!px-6 !py-4">
                                                <span className='text-red-500'>763589263hjcgdhs9089</span>
                                            </td>
